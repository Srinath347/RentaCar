...
public class VehicleService {
    ...
    public AvailableVehiclesSearchResult getVehiclesAvailable(AvailableVehiclesSearchParams params) {
        ...
        List<Integer> notAvailableVehicleIds = reservationRepository.findAllNotAvailableVehiclesBetweenDates(params.getFrom(), params.getTo(), ReservationStatus.ACTIVE_STATUSES);
    ...
    public boolean isVehicleAvailable(int vehicleId, LocalDateTime dateFrom, LocalDateTime dateTo) {
        return reservationRepository.findOverlappingForVehicle(vehicleId, dateFrom, dateTo, ReservationStatus.ACTIVE_STATUSES).isEmpty();
    }
