...
public class ReservationRestController {
    ...
    @PostMapping("/batch")
    public ResponseEntity<List<ReservationResponse>> createReservations(@RequestBody ReservationBatchRequest request) {
        List<ReservationResponse> body = this.reservationService.saveBatch(request).stream()
